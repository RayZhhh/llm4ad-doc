...
from .profiler import RandSampleProfiler, ProfilerBase
from ...base import *
...
class RandSample:
    def __init__(self,
        ...
        Args:
            ...
            profiler        : an instance of 'alevo.method.randsample.RandSampleProfiler'. If you do not want to use it, you can pass a 'None'.
                ...
                for program in programs_to_be_eval:
                    ...
                    future = self._evaluation_executor.submit(
                        partial(self._evaluator.evaluate_program_record_time,
                                program,
                                randsample=self)  # pass self to evaluator
                    )
    ...
    def run(self):
        if not self._resume_mode:
            ...
            score, eval_time = self._evaluator.evaluate_program_record_time(program=self._template_program, randsample=self)
            if score is None:
